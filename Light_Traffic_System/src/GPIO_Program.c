...
/* Return : Nothing                                                           */
/* Desc. : This Api allows the user to Set the Type of output pin             */
/******************************************************************************/
...
/* I/p Arguments : Copy_u8PortId Options: IOA, IOB                            */
/* I/p Arguments : Copy_u8PortValue:0x00->0xFFFF                              */
/* Return : Nothing                                                           */
/* Desc. : This Api allows the user to Set the Value of the port               */
/******************************************************************************/
void GPIO_voidSetLowerNibblePortValue(u8 Copy_u8PortId, u32 Copy_u8PortValue)
{
     /*i/p validation*/
    if((Copy_u8PortId > IOB) || (Copy_u8PortValue > 0xFFFF))
    {
        /*Do Nothing*/
    }
    else
    {
        ...
        {
            case IOA: for (u8 i = PIN0; i < PIN8; i++)
    					  {GPIO_voidSetPinValue(IOA, i, LOW);}

            GPIOA->ODR |= Copy_u8PortValue;
                      break;
            case IOB: for (u8 i = PIN0; i < PIN8; i++)
			  {GPIO_voidSetPinValue(IOB, i, LOW);}
